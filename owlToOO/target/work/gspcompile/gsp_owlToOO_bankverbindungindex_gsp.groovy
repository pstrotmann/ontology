...
class gsp_owlToOO_bankverbindungindex_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/bankverbindung/index.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(13)
invokeTag('sortableColumn','g',29,['property':("bic"),'title':(message(code: 'bankverbindung.bic.label', default: 'Bic'))],-1)
printHtmlPart(14)
invokeTag('message','g',31,['code':("bankverbindung.partner.label"),'default':("Partner")],-1)
printHtmlPart(15)
loop:{
int i = 0
...
invokeTag('link','g',39,['action':("show"),'id':(bankverbindungInstance.id)],3)
printHtmlPart(18)
...
printHtmlPart(20)
invokeTag('paginate','g',50,['total':(bankverbindungInstanceCount ?: 0)],-1)
printHtmlPart(21)
})
