...
class gsp_owlToOO_organisationedit_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/organisation/edit.gsp" }
public Object run() {
Writer out = getOut()
...
invokeTag('eachError','g',27,['bean':(organisationInstance),'var':("error")],3)
printHtmlPart(19)
})
invokeTag('hasErrors','g',29,['bean':(organisationInstance)],2)
printHtmlPart(12)
createTagBody(2, {->
printHtmlPart(20)
invokeTag('hiddenField','g',31,['name':("version"),'value':(organisationInstance?.version)],-1)
printHtmlPart(21)
...
invokeTag('form','g',38,['url':([resource:organisationInstance, action:'update']),'method':("PUT")],2)
printHtmlPart(24)
})
