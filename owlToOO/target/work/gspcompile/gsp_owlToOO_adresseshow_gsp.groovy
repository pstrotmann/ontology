...
class gsp_owlToOO_adresseshow_gsp extends GroovyPage {
...
printHtmlPart(18)
invokeTag('message','g',37,['code':("adresse.ort.label"),'default':("Ort")],-1)
printHtmlPart(19)
invokeTag('fieldValue','g',39,['bean':(adresseInstance),'field':("ort")],-1)
printHtmlPart(16)
}
printHtmlPart(17)
...
printHtmlPart(17)
if(true && (adresseInstance?.hausnummerZusatz)) {
printHtmlPart(24)
invokeTag('message','g',64,['code':("adresse.hausnummerZusatz.label"),'default':("Hausnummer Zusatz")],-1)
printHtmlPart(25)
