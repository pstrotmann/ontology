...
class gsp_owlToOO_adressecreate_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/adresse/create.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(1)
invokeTag('set','g',5,['var':("entityName"),'value':(message(code: 'adresse.label', default: 'Adresse'))],-1)
printHtmlPart(1)
createTagBody(2, {->
createTagBody(3, {->
...
invokeTag('eachError','g',25,['bean':(adresseInstance),'var':("error")],3)
printHtmlPart(18)
})
invokeTag('hasErrors','g',27,['bean':(adresseInstance)],2)
printHtmlPart(11)
createTagBody(2, {->
printHtmlPart(19)
...
invokeTag('form','g',35,['url':([resource:adresseInstance, action:'save'])],2)
printHtmlPart(22)
})
...
public static final long LAST_MODIFIED = 1501489268000L
